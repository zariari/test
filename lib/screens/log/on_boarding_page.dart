          ...
          children: [
            Stack(
              children: [
                ...
                Positioned(
                  top: screenHeight * 0.05, // Move the logo closer to the top
                  left: 0,
                  right: 0,
                  child: Center(
                    child: Image.asset(
            ...
            Expanded(
              child: Padding(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.start, // Align the text towards the top
                  children: [
                    const Text(
                    ...
                    const SizedBox(height: 20), // Reduced space between text and header
                    RichText(
                      textAlign: TextAlign.center,
                      text: const TextSpan(
                        style: TextStyle(
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.10, vertical: 10), // Dynamic button padding
